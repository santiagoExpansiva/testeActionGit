...
var _theme_dec, _text_dec, _a, _QuillEditor_decorators, _init;
import { html, css, LitElement } from "lit";
import { customElement, property } from "lit/decorators.js";
_QuillEditor_decorators = [customElement("editor-quill-100554")];
class QuillEditor extends (_a = LitElement, _text_dec = [property({ type: String, reflect: true })], _theme_dec = [property({ type: String })], _a) {
  constructor() {
    super(...arguments);
    this.text = __runInitializers(_init, 8, this, "Teste"), __runInitializers(_init, 11, this);
    this.theme = __runInitializers(_init, 12, this, "bubble"), __runInitializers(_init, 15, this);
    /*createRenderRoot() {
        return this;
    }*/
    this.isfocus = false;
  ...
  updated(changedProperties) {
    ...
    if (changedProperties.has("text") && this.shadowRoot) {
      this.init();
    }
  }
  init() {
    ...
    this.quill.container.querySelector(".ql-editor").onblur = () => {
      this.isfocus = false;
      const evento = new CustomEvent("onChange", {
        detail: { valor: this.quill.root.innerHTML },
        bubbles: true,
        composed: true
      });
...
__decorateElement(_init, 5, "text", _text_dec, QuillEditor);
__decorateElement(_init, 5, "theme", _theme_dec, QuillEditor);
QuillEditor = __decorateElement(_init, 0, "QuillEditor", _QuillEditor_decorators, QuillEditor);
QuillEditor.styles = css`
    .d-none {
    ...
    `;
__runInitializers(_init, 1, QuillEditor);
