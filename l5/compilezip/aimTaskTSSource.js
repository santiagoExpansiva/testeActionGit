...
var _AimTaskTSSource_decorators, _init, _a;
import { customElement } from "lit/decorators.js";
import { getInfoMyService } from "./_100554_aimHelper";
import { AimTaskBase } from "./_100554_aimTaskBase";
_AimTaskTSSource_decorators = [customElement("aim-task-t-s-source-100554")];
class AimTaskTSSource extends (_a = AimTaskBase) {
  onInitializing() {
    this.getSource();
  }
  getSource() {
  ...
  getFileSource() {
    return new Promise((resolve, reject) => __async(this, null, function* () {
      try {
        ...
        const ret = yield file.getContent();
...
AimTaskTSSource = __decorateElement(_init, 0, "AimTaskTSSource", _AimTaskTSSource_decorators, AimTaskTSSource);
__runInitializers(_init, 1, AimTaskTSSource);
