...
var _AimTaskDsStyles_decorators, _init, _a;
import { customElement } from "lit/decorators.js";
import { getInfoMyService } from "./_100554_aimHelper";
import { AimTaskBase } from "./_100554_aimTaskBase";
_AimTaskDsStyles_decorators = [customElement("aim-task-ds-styles-100554")];
class AimTaskDsStyles extends (_a = AimTaskBase) {
  onInitializing() {
    this.getSource();
  }
  getSource() {
    this.getStyle().then((ret) => {
      const result = ret;
...
AimTaskDsStyles = __decorateElement(_init, 0, "AimTaskDsStyles", _AimTaskDsStyles_decorators, AimTaskDsStyles);
__runInitializers(_init, 1, AimTaskDsStyles);
export {
  AimTaskDsStyles
};
