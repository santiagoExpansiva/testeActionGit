...
var _IcaLayoutFlowRow_decorators, _init, _a;
import { customElement } from "lit/decorators.js";
import { IcaLitElementBase } from "./_100554_icaLitElementBase";
_IcaLayoutFlowRow_decorators = [customElement("ica-layout-flow-row-100554")];
class IcaLayoutFlowRow extends (_a = IcaLitElementBase) {
  constructor() {
    super(...arguments);
  ...
  commandMove(scope, target) {
    ...
    const elMychildren = document.createElement("span");
...
IcaLayoutFlowRow = __decorateElement(_init, 0, "IcaLayoutFlowRow", _IcaLayoutFlowRow_decorators, IcaLayoutFlowRow);
__runInitializers(_init, 1, IcaLayoutFlowRow);
export {
  IcaLayoutFlowRow
};
