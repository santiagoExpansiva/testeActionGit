...
var _globalVariation_dec, _a, _init;
...
class CollabLitElement extends (_a = LitElement, _globalVariation_dec = [property({ type: Number })], _a) {
  constructor() {
    super(...arguments);
    this.globalVariation = __runInitializers(_init, 8, this, window.globalVariation || 0), __runInitializers(_init, 11, this);
  }
  /**
   * Update shared state.
...
__decorateElement(_init, 5, "globalVariation", _globalVariation_dec, CollabLitElement);
export {
  CollabLitElement,
  collabState
};
