...
var _AimTaskDsTokens_decorators, _init, _a;
import { customElement } from "lit/decorators.js";
import { getInfoMyService } from "./_100554_aimHelper";
import { AimTaskBase } from "./_100554_aimTaskBase";
_AimTaskDsTokens_decorators = [customElement("aim-task-ds-tokens-100554")];
class AimTaskDsTokens extends (_a = AimTaskBase) {
  onInitializing() {
    this.getSource();
  }
  getSource() {
...
AimTaskDsTokens = __decorateElement(_init, 0, "AimTaskDsTokens", _AimTaskDsTokens_decorators, AimTaskDsTokens);
__runInitializers(_init, 1, AimTaskDsTokens);
