...
var _theme_dec, _a, _WCDToolboxItemActionQuill_decorators, _init;
import { html, LitElement, render } from "lit";
import { customElement, property } from "lit/decorators.js";
_WCDToolboxItemActionQuill_decorators = [customElement("wcd-toolbox-item-action-edit-quill-100554")];
class WCDToolboxItemActionQuill extends (_a = LitElement, _theme_dec = [property({ type: String })], _a) {
  constructor() {
    super(...arguments);
    this.theme = __runInitializers(_init, 8, this, "snow"), __runInitializers(_init, 11, this);
    //-------------------------------------------
    this.isfocus = false;
    this.styles = `
    .ql-toolbar.ql-snow{
...
__decorateElement(_init, 5, "theme", _theme_dec, WCDToolboxItemActionQuill);
WCDToolboxItemActionQuill = __decorateElement(_init, 0, "WCDToolboxItemActionQuill", _WCDToolboxItemActionQuill_decorators, WCDToolboxItemActionQuill);
__runInitializers(_init, 1, WCDToolboxItemActionQuill);
const getTemplate = (mode = "", position = "") => {
  let ret = templateActionQuill.editQuill;
...
const templateActionQuill = {
  ...
  editQuill: {
    ...
    onclick: (e, wc, fc) => {
      var _a2;
      const elQuill = (_a2 = wc.shadowRoot) == null ? void 0 : _a2.querySelector("wcd-toolbox-item-action-edit-quill-100554");
      if (elQuill) return;
      wc.setIconsWcdToolbox([templateActionQuill.backButton]);
      const el = document.createElement("wcd-toolbox-item-action-edit-quill-100554");
      el.myParent = wc;
      el.elMain = wc.elMain;
      el.elFCA = wc.parentElement;
