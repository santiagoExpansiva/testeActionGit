...
var _textarea_dec, _a, _AimActionTokensNew_decorators, _init;
...
_AimActionTokensNew_decorators = [customElement("aim-action-tokens-new-100554")];
class AimActionTokensNew extends (_a = AimActionBase, _textarea_dec = [query("textarea")], _a) {
  constructor() {
    super(...arguments);
...
__decorateElement(_init, 5, "textarea", _textarea_dec, AimActionTokensNew);
AimActionTokensNew = __decorateElement(_init, 0, "AimActionTokensNew", _AimActionTokensNew_decorators, AimActionTokensNew);
__runInitializers(_init, 1, AimActionTokensNew);
export {
  AimActionTokensNew
};
