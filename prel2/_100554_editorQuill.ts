/// <mls shortName="editorQuill" project="100554" enhancement="_100554_enhancementLit" groupName="other" />

/// <mls shortName="editorQuill" project="100552" enhancement="_100541_enhancementLit" groupName="editor" />
import { html, css, LitElement, unsafeHTML, unsafeCSS } from 'lit';
import { customElement, property } from 'lit/decorators.js';
declare var Quill: any;
@customElement('editor-quill-100554')
class QuillEditor extends LitElement {

    @property({ type: String, reflect: true })
    private text: string = "Teste";
    ...
    updated(changedProperties: any) {
        ...
        if (changedProperties.has('text') && this.shadowRoot) {
            // Verifica se o atributo 'texto' foi alterado e se o shadowRoot está disponível
            this.init();
