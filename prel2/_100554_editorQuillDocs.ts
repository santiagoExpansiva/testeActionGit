...
export class EditorQuillDocs100554 extends LitElement {
    ...
    @query('.doc-section-editor')
    containerQuillEditor: HTMLElement | undefined;
    ...
    private onOpenedChanged(value: boolean) {
        ...
        const toolbar = this.containerEditor.querySelector('.ql-toolbar') as HTMLElement;
        const editor = this.containerEditor.querySelector('.ql-editor') as HTMLElement;;
